...
* library-web-classic - Программа для хранения информации о книгах с "классическим" веб-интерфейсом (ДЗ 09, 12-13, 16-17)
...
* sw-data-service - Программа для получения данных о фильмах "Звёздных войн". Написана в рамках задания по Hystrix (ДЗ 18)